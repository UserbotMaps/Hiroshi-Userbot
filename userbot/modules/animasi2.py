...
@hiro_cmd(pattern=r"^\.(yes|no|maybe|decide)$")
...
@hiro_cmd(pattern=r"^\.fp$")
async def facepalm(e):
    await e.edit("🤦‍♂")


@hiro_cmd(pattern=r"^\.cry$")
async def cry(e):
    await e.edit(choice(CRI))


@hiro_cmd(pattern=r"^\.insult$")
async def insult(e):
    await e.edit(choice(INSULT_STRINGS))


@hiro_cmd(pattern=r"^\.cp(?: |$)(.*)")
...
@hiro_cmd(pattern=r"^\.hello$")
async def hoi(hello):
    await hello.edit(choice(HELLOSTR))


@hiro_cmd(pattern=r"^\.owo(?: |$)(.*)")
async def focos(owo):
...
@hiro_cmd(pattern=r"^\.react$")
async def react_meme(react):
    await react.edit(choice(FACEREACTS))


@hiro_cmd(pattern=r"^\.shg$")
async def shrugger(shg):
    await shg.edit(choice(SHGS))


@hiro_cmd(pattern=r"^\.chase$")
async def police(chase):
    await chase.edit(choice(CHASE_STR))


@hiro_cmd(pattern=r"^\.run$")
async def runner_lol(run):
    await run.edit(choice(RUNS_STR))


@hiro_cmd(pattern=r"^\.metoo$")
async def metoo(hahayes):
    await hahayes.edit(choice(METOOSTR))


@hiro_cmd(pattern="^Oof$")
async def Oof(e):
    t = "Oof"
    for _ in range(15):
        t = t[:-1] + "of"
...
@hiro_cmd(pattern=r"^\.10iq$")
async def iqless(e):
    await e.edit("♿")


@hiro_cmd(pattern=r"^\.fuck$")
async def iqbot(e):
    await e.edit("🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕🖕🖕🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕\n🖕🖕")


@hiro_cmd(pattern=r"^\.bye$")
async def iqboot(e):
    await e.edit("Kek thx bye")


@hiro_cmd(pattern=r"^\.moon$")
...
@hiro_cmd(pattern=r"^\.taco$")
async def taco(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(r"{\__/}" "\n(●_●)" "\n( >🌮 Want a taco?")


@hiro_cmd(pattern=r"^\.paw$")
async def paw(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")


@hiro_cmd(pattern=r"^\.tf$")
async def tf(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("(̿▀̿ ̿Ĺ̯̿̿▀̿ ̿)̄  ")


@hiro_cmd(pattern=r"^\.gey$")
async def gey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
...
@hiro_cmd(pattern=r"^\.(?:penis|dick)\s?(.)?")
