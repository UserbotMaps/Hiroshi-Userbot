...
async def redis(alive):
    ...
    output = (
        ...
        f"  **[ɢʀᴏᴜᴘꜱ](https://t.me/hiroshisupport)** | **[ᴄʜᴀɴɴᴇʟ](https://t.me/hiroshimabes)** | **[ᴏᴡɴᴇʀ](https://t.me/IDnyaKosong)** | **[ɢɪᴛʜᴜʙ](https://github.com/muhammadrizky16/Kyy-Userbot)**"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
