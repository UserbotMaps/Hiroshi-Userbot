...
@hiro_cmd(pattern="wibu2(?: |$)(.*)")
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(0.07)
    await typew.edit("**Sial Ada Wibu Ajg😨**")
    sleep(0.07)
    await typew.edit("**Sekuat Apapun Gua😭**")
    sleep(0.07)
    await typew.edit("**Jika Ada Wibu😨 Di Sini Kontol**")
    sleep(0.07)
