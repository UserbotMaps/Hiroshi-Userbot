...
from userbot.utils import progress, humanbytes, edit_or_reply, edit_delete, hiro_cmd


@hiro_cmd(pattern="download(?: |$)(.*)")
...
@hiro_cmd(pattern="uploadas(stream|vn|all) (.*)")
