...
async def update(event, repo, ups_rem, ac_br):
    ...
    x = await edit_or_reply(event, "**🔥ʜɪʀᴏsʜɪ-ᴜsᴇʀʙᴏᴛ🔥** `Berhasil Di Update!`")
    await asyncio.sleep(1)
    await x.edit("**🔥ʜɪʀᴏsʜɪ-ᴜsᴇʀʙᴏᴛ🔥** `Di Restart....`")
    await asyncio.sleep(1)
...
async def upstream(event):
    ...
    if changelog == "" and force_update is False:
        await xx.edit(
            f"\n🔥ʜɪʀᴏsʜɪ-ᴜsᴇʀʙᴏᴛ🔥 Sudah Versi Terbaru || Tunggu Update Terbaru Dari Hiroshi Userbot\n"
        )
    ...
    if force_update:
        ...
        await xx.edit("` Proses Update 🔥ʜɪʀᴏsʜɪ-ᴜsᴇʀʙᴏᴛ🔥, Loading....1%`")
        await xx.edit("` Proses Update 🔥ʜɪʀᴏsʜɪ-ᴜsᴇʀʙᴏᴛ🔥, Loading....20%`")
        await xx.edit("` Proses Update 🔥ʜɪʀᴏsʜɪ-ᴜsᴇʀʙᴏᴛ🔥, Loading....35%`")
        await xx.edit("` Proses Update 🔥ʜɪʀᴏsʜɪ-ᴜsᴇʀʙᴏᴛ🔥, Loading....77%`")
        await xx.edit("` Proses Update 🔥ʜɪʀᴏsʜɪ-ᴜsᴇʀʙᴏᴛ🔥, Updating...90%`")
        await xx.edit(
